...
data_idx = sample(nrow(data), sample_size)
data_trn = data[data_idx, ]
data_tst = data[-data_idx, ]

# quantile normalized data set
sample_size = floor(ratio * nrow(quantile_data))
quantile_data_idx = sample(nrow(quantile_data), sample_size)
quantile_data_trn = quantile_data[quantile_data_idx,]
quantile_data_tst = quantile_data[-quantile_data_idx, ]
```

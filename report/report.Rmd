...
Let's move towards a more explainable model


```{r}
str(quantile_data_trn)
model_explain = lm(popularity ~ . -genre, data = quantile_data_trn)
```
...
TODO: This plot does not look as good as in the outsourced version. Find out why.
...
# TODO: Fit the explainable model with all two-way interactions. Run stepwise search to kick out unnecessary ones.
